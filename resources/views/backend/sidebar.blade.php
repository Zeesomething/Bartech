    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item ">
            <a href="{{ route('kabupaten.index') }}" class="menu-link">
                ...
                <div data-i18n="Dashboards">Kabupaten</div>
            </a>
        </li>
        <li class="menu-item ">
            <a href="{{ route('kecamatan.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-layout"></i>
                <div data-i18n="Dashboards">Kecamatan</div>
            </a>
        </li>
        <li class="menu-item ">
            <a href="{{ route('home') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-layout"></i>
                <div data-i18n="Dashboards">Logika</div>
            </a>
        </li>
        ...
        {{-- <li class="menu-item open">
            <a href="javascript:void(0);" class="menu-link menu-toggle mt-2">
                <i class="menu-icon tf-icons bx bx-layout"></i>
        ...
        <li class="menu-item open">
            <a href="{{ route('welcome') }}" class="menu-link mt-2">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
